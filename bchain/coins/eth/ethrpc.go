...
const (
	...
	// BinanceSmartChain is production network for BSC
	BinanceSmartChain EthereumNet = 56
	// BinanceSmartChainTestnet is test network for BSC
	BinanceSmartChainTestnet EthereumNet = 97
)
...
func (b *EthereumRPC) Initialize() error {
	...
	case BinanceSmartChain:
		b.Testnet = false
		b.Network = "binancesmartchain"

	case BinanceSmartChainTestnet:
		b.Testnet = true
		b.Network = "binancesmartchain_testnet"
